...
export const helpList = [
  ...
  "Attain the life situation you desire.",
  ...
  "Heal from childhood wounding and do inner child work– including issues stemming from growing up in a dysfunctional family / culture",
  "Heal from adult trauma– including difficult relationships/breakups and traumatic events (PTSD)",
  "Overcome burnout and chronic stress, and restore your energy and resilience",
  ...
  "Cultivate spiritual insight, connection, and growth– enriched by spiritual traditions and practices",
  "Enliven your connection to the energy body, intuition, and sensitivity– enriched by spiritual practices",
  "Actualize your gifts, purpose, voice, and sovereignty. Stop being controlled by interfering cultural, ancestral, and inherited patterns and beliefs",
  ...
  "Shift limiting money mindsets and blocks, and open to abundance",
  "Relieve or resolve physical pain, tension, and psychosomatically-rooted conditions",
  "Enhance performance in athletics, work, intimacy, and daily life",
  "Improve sleep quality and address insomnia",
  "Build confidence and clarity for important decisions, conversations, major life, career, and purpose transitions, and daily living",
  "Work on Men's issues and divine masculine development",

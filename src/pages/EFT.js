...
const EFT = () => {
  const services = [
    {
      ...
      description: 'A powerful somatic tool often called "Tapping." It combines ancient Chinese acupressure with modern psychology to release emotional blocks and rewire the nervous system.',
      process: [
        'Identify the specific issue, emotion, or physical sensation',
        'Rate the intensity on a scale of 0-10',
        'Tap on specific meridian points while voicing the truth of how you feel',
        'Use positive affirmations to reframe and integrate',
        'Re-rate intensity to measure the shift'
      ],
      benefits: [
        'Rapid relief from anxiety, stress, and overwhelm',
        'Releasing stuck grief and anger',
        'Shifting limiting subconscious beliefs',
        'Calming the amygdala (fight/flight response)',
        'Safe processing of past trauma'
      ]
    },
    {
      title: 'Emotional Processing & Upgrading',
      description: 'Beyond just relief, we use EFT to upgrade your emotional baseline. We transform heavy emotions into wisdom and integrate them for lasting growth.',
      process: [
        'Create a safe, non-judgmental container',
        'Identify core emotional patterns',
        'Allow full expression without bypassing',
        'Explore underlying beliefs driving the emotion',
        'Integrate the wisdom and release the charge'
      ],
      benefits: [
        'Increased emotional intelligence',
        'Transformation of pain into wisdom',
        'Greater resilience and regulation',
  ...
  return (
    ...
    //         <h1>Emotional Freedom Techniques</h1>
    ...
    <section className="eft-hero">
      <div className="container">
        <div className="eft-hero-content">
          <h1>EFT (Tapping)</h1>
          <p className="eft-subtitle">
            Rapidly process emotions, release stress, and rewire your nervous system for peace.
          </p>
        </div>
      </div>
    </section>

  ...
  return (
    <div className="home">
      <Helmet>
        ...
        <meta name="description" content="Transform your life with EFT Tapping, Reiki Energy Healing, and Spiritual Counseling. Based in West Philadelphia & Virtual." />
        <meta property="og:title" content="Healing On Tap | Integrative Healing & Guidance" />
        <meta property="og:description" content="Transform your life with EFT Tapping, Reiki Energy Healing, and Spiritual Counseling. Based in West Philadelphia & Virtual." />
      </Helmet>
      {/* Hero Section */}

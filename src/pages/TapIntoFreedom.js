    ...
    <div className="tap-into-freedom">
      ...
      <section className="tif-hero">
        <div className="container">
          ...
          <p className="tif-hero-line">Restore freedom <u className="tif-underline">for good.</u></p>
      ...
      <section className="tif-intro section-dark">
        <div className="container">
          <p className="tif-center tif-narrow">
      ...
      <section className="tif-benefits section-rainbow">
        <div className="container">
          ...
          <div className="tif-cta-center">
            <a href="#investment" className="btn">Yep, That's What I Want →</a>
          </div>
      ...
      <section className="tif-investment section-dark" id="investment">
        <div className="container">
          ...
          <br></br>
          <p className="tif-center"><em>Payment plans available.</em></p>
...
//               {/* These two sidebars are positioned lower (top: 600px, roughly level
//                   with the blockquote below) — placed here in the DOM, right before
//                   that blockquote, so mobile stacking reads them in the same relative
//                   order they visually appear in on desktop. */}
...
//               {/* Both positioned lower on desktop (top: 700px, roughly level with
//                   the Sonya Sophia quote just below) — placed together here in the
//                   DOM so mobile stacking matches that same relative position. */}
...
//               {/* Positioned lower on desktop (top: 340px, roughly level with this
//                   point in the text) — placed here in the DOM so mobile stacking
//                   matches that same relative position instead of jumping to the end. */}

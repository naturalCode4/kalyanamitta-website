        ...
        <div className="container">
          <div className="about-adin-content">
            ...
            <div className="about-adin-text">
              <p>Adin is a healer and spiritual guide who helps people transform, heal, and align with their inherent wisdom and basic goodness. His mission is to support you however he can by offering loving presence, powerful modalities, and wisdom—practicing Right Livelihood in doing so. His approach is integrative and personal, grounded in intuition, science, and various spiritual traditions.
              </p>
